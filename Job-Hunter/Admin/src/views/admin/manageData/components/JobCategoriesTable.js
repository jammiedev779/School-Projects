...
const JobCategoriesTable = () => {
  ...
  const {jobCategories} = useStateContext();
    ...
    <div className="container mx-auto ">
      ...
      <table className="min-w-full bg-white bg-clip-border shadow-3xl shadow-shadow-500 dark:!bg-navy-800 dark:text-white dark:shadow-none ">
        ...
        <tr >
            ...
            <th className="border-b border-gray-200 pr-32 pb-[10px] text-start dark:!border-navy-700 ">
                <div className="text-xs font-bold tracking-wide text-gray-600">Icon</div>
            </th>
          </tr>
        </thead>
        <tbody>
            ...
            >
              ...
              <td>
                {editingRow === index ? (
                  <input
                    type="text"
                    value={jobCategory.job_name}
                    className="border border-gray-300 rounded py-1 px-2"
                  />
                ) : (
                  <p className="text-sm font-bold text-navy-700 dark:text-white">{jobCategory.job_name}</p>
