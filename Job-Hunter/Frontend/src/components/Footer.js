...
export default function Footer() {
    return <>
        <div className="grid grid-cols-3 items-start justify-between bg-white text-one py-12 border-t-2 border-one">
            <div className="flex flex-col h-max gap-y-7 w-full items-center  justify-start xs:px-24 px-5 ">
                <div className="font-bold lg:text-xl mn:text-base text-xs w-max">Our social media</div>
                <div className="flex items-center justify-center gap-x-7">
                    <img className="lg:w-10 lg:h-10 mn:w-9 md:w-8 sm:w-7 xs:w-6 w-4" src={IconFacebook} alt='' />
                    <img className="lg:w-10 lg:h-10 mn:w-9 md:w-8 sm:w-7 xs:w-6 w-4" src={IconInstagram} alt='' />
                    <img className="lg:w-10 lg:h-10 mn:w-9 md:w-8 sm:w-7 xs:w-6 w-4" src={IconTwitter} alt='' />
                </div>
            </div>
            <div className="flex flex-col gap-y-2 justify-center xs:pl-12 pl-0">
                <div className="font-bold lg:text-xl mn:text-base text-xs w-max">Contact</div>
            ...
            <div className="flex flex-col w-full lg:pl-32 mn:pl-24 md:pl-20 sm:pl-20 xs:pl-16 pl-12 ">
